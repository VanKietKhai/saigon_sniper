...
from .ellipse import fit_human_calibration_ellipse, fit_human_hole_ellipse, guided_opposite_line_center
...
def append_annotation(payload: Mapping[str, object], manifest: SourceManifest, reference: FrozenReference) -> dict[str, object]:
    ...
    target_center = guided_opposite_line_center(calibration_points, calibration, "Target calibration")
    hole_center = guided_opposite_line_center(hole_boundary_points, hole, "Hole boundary")
    result = derive_provisional_result(source_id, calibration, {"x_px": hole_center.center_x_px, "y_px": hole_center.center_y_px}, reference, {"x_px": target_center.center_x_px, "y_px": target_center.center_y_px})
    path = annotations_path()
    row = {"schema_version":"2.0", "annotation_id":str(uuid.uuid4()), "source_id":source_id, "image_sha256":record["image_sha256"], "annotation_pass":annotation_pass, "labeler_id":labeler_id, "annotation_timestamp_utc":datetime.now(timezone.utc).isoformat(), "rule_set_id":reference.rule_set_id, "software_version":SOFTWARE_VERSION, "image_width_px":width, "image_height_px":height, "calibration_method":"ring1_outer_8pt_v2", "calibration_reference_diameter_mm":reference.calibration_radius_mm*2, "calibration_points":json.dumps(calibration_points,separators=(",",":")), "calibration_center_x_px":calibration.center_x_px, "calibration_center_y_px":calibration.center_y_px, "calibration_radius_x_px":calibration.radius_major_px, "calibration_radius_y_px":calibration.radius_minor_px, "calibration_rotation_deg":calibration.rotation_deg, "calibration_fit_residual_px":calibration.calibration_fit_residual_px, "bull_center_x_px":target_center.center_x_px, "bull_center_y_px":target_center.center_y_px, "manual_visual_bull_center_x_px":None, "manual_visual_bull_center_y_px":None, "target_center_method":"manual_opposite_line_intersection_v1", "target_label_quality":target_quality, "hole_center_method":"manual_opposite_line_intersection_v1", "hole_center_x_px":hole_center.center_x_px, "hole_center_y_px":hole_center.center_y_px, "hole_boundary_points":json.dumps(hole_boundary_points,separators=(",",":")), "hole_ellipse_center_x_px":hole.center_x_px, "hole_ellipse_center_y_px":hole.center_y_px, "hole_ellipse_radius_major_px":hole.radius_major_px, "hole_ellipse_radius_minor_px":hole.radius_minor_px, "hole_ellipse_angle_deg":hole.rotation_deg, "hole_ellipse_rms_residual_px":hole.hole_ellipse_rms_residual_px, "hole_ellipse_max_residual_px":hole.hole_ellipse_max_residual_px, "hole_label_quality":hole_quality, "center_distance_px":math.hypot(hole_center.center_x_px-target_center.center_x_px,hole_center.center_y_px-target_center.center_y_px), "center_distance_mm":result.center_distance_mm, "mm_per_pixel_x":result.mm_per_px_major, "mm_per_pixel_y":result.mm_per_px_minor, "perspective_status":"", "label_quality":"", "review_status":"unreviewed", "derived_score_tenths":result.provisional_score_tenths, "notes":notes}
    with _LOCK:
